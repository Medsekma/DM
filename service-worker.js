const CACHE='dmpharma-cloudflare-v7';
const FILES=['/','/index.html','/styles.css?v=2026-01','/script.js?v=82','/manifest.webmanifest','/assets/logo.png','/assets/cleanroom.webp','/assets/products.webp','/assets/products-ar.webp','/assets/softject-logo.png','/assets/icon-192.png'];
